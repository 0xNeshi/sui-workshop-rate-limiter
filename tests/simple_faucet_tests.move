...
use sui_workshop_rate_limiter::simple_faucet::{Self, Faucet, SIMPLE_FAUCET};
...
fun faucet_global_throttle() {
    ...
    simple_faucet::init_for_testing(scenario.ctx());
    ...
    // Drain it completely: 100 claims of 1 SIMPLE_FAUCET each.
    let mut i: u64 = 0;
    while (i < 100) {
